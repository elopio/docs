...
UniverseForked            | [Augur](https://github.com/AugurProject/augur-core/blob/master/source/contracts/Augur.sol) | A Market in `universe` has had its Tentative Outcome disputed during the Last Report Round, which has caused `universe` to Fork. | universe |
