...
When a Fork is initiated, the [Parent Universe](#parent-universe) becomes permanently [Locked](#locked-universe). In a Locked Universe, no new Markets may be created. Users may continue trading Shares in Markets in Locked Universes, but no Reporting rewards are paid out there, and Markets in Locked Universes cannot be Finalized. In order for Markets or REP tokens in the Locked Universe to be useful, they must first be migrated to a Child Universe.
