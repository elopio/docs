...
In this way, all REP holders who participate during a Fee Window will receive a portion of the fees collected during that window. Participation includes [Designated Reporting](#designated-reporting) or [Open Reporting](#open-reporting), [Disputing](#dispute) an Outcome, or simply purchasing Participation Tokens directly.
...
Once a [First Public Report](#first-public-report) has been received, the Reported Outcome becomes the Market’s Tentative Outcome, and the Market enters the [Waiting for the Next Fee Window to Begin Phase](#waiting-for-the-next-fee-window-to-begin-phase) (4).
