...
The [Pre-Reporting Phase](#pre-reporting-phase) (1) is the time period where the Market's [End Time](#end-time) has not come to pass, generally this is the most active trading period. Once the End Time has come to pass, the Market enters the [Designated Reporting Phase](#designated-report-phase) (2).
...
When a Fork is initiated, all REP [Staked](#designated-reporter-stake) on all non-Forking Markets is unstaked so that it is free to be migrated to a Child Universe during the Forking Period.
