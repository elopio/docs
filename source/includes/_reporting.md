...
The Market’s First Public Reporter receives the forfeited No-Show Bond in the form of Stake on their chosen Outcome, so they may claim the [No-Show REP Bond](#designated-report-no-show-rep-bond) only if their Reported Outcome agrees with the Market’s [Final Outcome](#final-outcome).
