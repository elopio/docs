...
The Market’s First Public Reporter receives the forfeited No-Show Bond in the form of Stake on their chosen Outcome, so they may claim the [No-Show REP Bond](#designated-report-no-show-gas-bond) only if their Reported Outcome agrees with the Market’s [Final Outcome](#final-outcome). They also receive the [No-Show Gas Bond](#designated-report-no-show-rep-bond) after the Market has Finalized only if their Reported Outcome agrees with the Market’s Final Outcome.
...
If the Designated Reporter fails to Report within the Designated Reporting Phase, the [No-Show REP Bond](#designated-report-no-show-rep-bond), the [No-Show Gas Bond](#designated-report-no-show-gas-bond), and the Market is moved into the [Open Reporting Phase](#open-reporting-phase). These [No-Show Bonds](#designated-report-no-show-bond) are then used to help pay for the gas costs and add to the [REP](#rep) [Staked](#first-public-reporter-stake) by the [First Public Reporter](#first-public-reporter).
